...
class SearchDao{
    ...
    func getResultadosFromApiForQuery(query:String,completion: @escaping ([Resultado]) -> Void){
        let url = "https://api.unsplash.com/search/photos?client_id=7687549ae04e25e1c51b00bb9804c2f57ce83ad89698c2e996e4b23027fc274e&page=1&query=\(query)"
